    ...
    (
        ...
        $(
            $(
                ...
                impl<Pin> OnChannel<$dma::$TxChannel> for serial::Tx<$USART, Pin> where Pin: serial::TxPin<$USART> {}
                impl<Pin> crate::private::Sealed for serial::Rx<$USART, Pin> {}
                impl<Pin> OnChannel<$dma::$RxChannel> for serial::Rx<$USART, Pin> where Pin: serial::RxPin<$USART> {}
